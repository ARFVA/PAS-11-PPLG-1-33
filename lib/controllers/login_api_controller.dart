...
import 'package:pas_mobile_11_pplg_1_33/models/login_api_model.dart';
import 'package:pas_mobile_11_pplg_1_33/models/register_api_model.dart';
import 'package:pas_mobile_11_pplg_1_33/network/client_network.dart';
...
class LoginApiController extends GetxController {
  ...
  final usernamControllerregister = TextEditingController();
  ...
  void register() async {
    ...
    try {
      final response = await ClientNetwork.postRequest('latihan/register-user', {
            "username": usernamControllerregister.text.trim(),
      ...
      if (response.statusCode == 200) {
        if (data["status"] == true) {
          ...
          await prefs.setString("username", usernamControllerregister.text.trim());
    ...
    try {
      ...
      if (response.statusCode == 200) {
        if (data['status'] == true) {
          ...
          name.value = usernamController.text.trim();
          email.value = "${usernamController.text.trim()}@gmail.com";
